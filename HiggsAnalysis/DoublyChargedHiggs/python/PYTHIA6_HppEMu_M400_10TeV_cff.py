...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/UserCode/JHGoh/HiggsAnalysis/DoublyChargedHiggs/python/PYTHIA6_HppEMu_M400_10TeV_cff.py,v $'),
