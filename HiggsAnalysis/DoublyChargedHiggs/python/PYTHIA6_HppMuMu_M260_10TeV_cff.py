...
#    crossSection = cms.untracked.double(7.1),
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'PARP(182)= 0.0          !H++ coupling with emu', 
            'PARP(183)= 0.0          !H++ coupling with etau', 
            'PARP(184)= 0.0          !H++ coupling with mue', 
            'PARP(185)= 0.1          !H++ coupling with mumu', 
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/UserCode/JHGoh/HiggsAnalysis/DoublyChargedHiggs/python/PYTHIA6_HppMuMu_M260_10TeV_cff.py,v $'),
